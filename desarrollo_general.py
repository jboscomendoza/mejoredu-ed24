...
with tab_nac:
    ...
    for campo in campos:
        ...
        plot_nac_campo = plot_bar(p_nac_campo, "nivel_grado")
...
with tab_ser:
    ...
    for campo in campos:
        ...
        plot_ser_campo = plot_bar(p_ser_campo, "nivel_grado")
...
with tab_sex:
    ...
    for campo in campos:
        ...
        plot_sex_campo = plot_bar(p_sex_campo, "nivel_grado")
...
with tab_ent:
    ...
    for campo in campos:
        ...
        plot_ent_campo = plot_bar(p_ent_campo, "nivel_grado")
