...
#### Page ####
st.title("Resultados de la evaluación diagnóstica 2024-2025 - Comparativo de criterios")
...
A continuación se presenta la proporción de respuestas que fueron asignadas a cada nivel de desarrollo para cada uno de los criterios evaluados, en comparativos por distintos niveles de agregación.
